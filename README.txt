...
## Code Smell Changes
Reed: Removed unused class PatientBuilder.js
Chris: Removed unnecessary comments used for clarification during coding throughout the project
Aaron: Removed unnecessary class App.test.js from the UI
Steve: Improved login functionality